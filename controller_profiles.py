...
def keyboard_player_controller(icc, ic_x, ic_y, ic_dash):
...
def xbox_player_controller(icc, ic_x, ic_y, ic_dash):
...
def build_player_controller_icc(profile):
	...
	profile(icc, ic_x, ic_y, ic_dash)
	return icc, ic_x, ic_y, ic_dash